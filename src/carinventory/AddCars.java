...
public class AddCars extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Rental Location");
    ...
    private void AddCarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddCarActionPerformed
        // TODO add your handling code here:
        Cars c1 =new Cars();
        c1.setCarId(Integer.parseInt(jTextField1.getText()));
        c1.setMake(jTextField2.getText());
        c1.setModel(jTextField3.getText());
        c1.setCarYear(Short.parseShort(jTextField4.getText()));
        c1.setRentalLocation(jTextField5.getText());
        c1.setPrice(Double.parseDouble(jTextField6.getText()));
        EntityManagerFactory emf = (EntityManagerFactory) Persistence.createEntityManagerFactory("CarInventoryPU");
        CarsJpaController cjc = new CarsJpaController(emf);
        try {
            cjc.create(c1);
        } catch (Exception ex) {
